...
import threading
import time
import external_api.news as news
import external_api.reddit_api as reddit
...
def run_scheduler():
    ...
    schedule.every(10).days.at("02:00").do(news.get_news_data)
    schedule.every(10).days.at("03:00").do(reddit.reddit_api)
    
    schedule.every().days.at("00:00").do(notification.testing_function)
